...
submissions = [submission for submission in submissions if submission.domain in config["domains"] and '.gifv' not in submission.url and submission.over_18==False and len(submission.title)<=225]
